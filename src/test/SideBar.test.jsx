...
import SideBar, { StyledSection } from "../components/SideBar";
...
describe("SideBar component", () => {
    ...
    it("renders the list of sidebar items", () => {
      ...
      expect(wrapper.find("ul li").at(0).text()).toEqual("Users");
      expect(wrapper.find("ul li").at(1).text()).toEqual("Messages");
      expect(wrapper.find("ul li").at(2).text()).toEqual("Posts");
      expect(wrapper.find("ul li").at(3).text()).toEqual("Admins");
    });
  ...
  it("should have a background color of #282c34", () => {
    expect(wrapper.find(".sidebar").prop("style").backgroundColor).toEqual("#282c34");
  });
  ...
  it("should have a list-style-type of none", () => {
    expect(wrapper.find(".sidebar ul").prop("style").listStyleType).toEqual("none");
  });
